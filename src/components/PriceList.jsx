...
const PRICE_DATA = {
  kartvizit: [
    { code: 'SKAYT', name: 'Sıvama (Çift Yön Kabartma Lak Tek Yön Varak Altın Yaldız Özel Kesimli)', size: '5 x 8 cm', paper: '300 Gr + 300 Gr / Amerikan Bristol', lamination: 'Mat Selefon', sides: 'Çift Yön', qty: '1000', price: '1.450,00 TL' },
    { code: 'SKAYÇ', name: 'Sıvama (Çift Yön Kabartma Lak Çift Yön Varak Altın Yaldız Özel Kesimli)', size: '5 x 8 cm', paper: '300 Gr + 300 Gr / Amerikan Bristol', lamination: 'Mat Selefon', sides: 'Çift Yön', qty: '1000', price: '1.650,00 TL' },
    { code: 'ŞEFB4K', name: 'Şeffaf Kartvizit (Beyaz+Cmyk+Kabartma Lak)', size: '5 x 8 cm', paper: '400 Micron Asetat', lamination: 'Selefon Yok', sides: 'Tek Yön', qty: '500', price: '2.350,00 TL' },
    { code: 'ŞEFB4', name: 'Şeffaf Kartvizit (Beyaz+Cmyk)', size: '5 x 8 cm', paper: '400 Micron Asetat', lamination: 'Selefon Yok', sides: 'Tek Yön', qty: '500', price: '1.950,00 TL' },
    { code: 'ŞEFN', name: 'Şeffaf Kartvizit (CMYK)', size: '5 x 8 cm', paper: '400 Micron Asetat', lamination: 'Selefon Yok', sides: 'Tek Yön', qty: '500', price: '1.800,00 TL' },
    { code: 'AYD', name: 'Düz Kesim Tek Yön Varak Altın Yaldız', size: '5.2 x 8.2 cm', paper: 'Kuşe / 350 Gr.', lamination: 'Mat Selefon', sides: 'Çift Yön', qty: '1000', price: '800,00 TL' },
    { code: 'AYG', name: 'Özel Kesim Tek Yön Altın Yaldız+Gofre', size: '5 x 8 cm', paper: 'Kuşe / 350 Gr.', lamination: 'Mat Selefon', sides: 'Çift Yön', qty: '1000', price: '1.750,00 TL' },
    { code: 'SAYT', name: 'Sıvama (Çift Yön Renkli Baskı Tek Yön Varak Altın Yaldız Özel Kesimli)', size: '5 x 8 cm', paper: '300 Gr + 300 Gr / Amerikan Bristol', lamination: 'Mat Selefon', sides: 'Çift Yön', qty: '1000', price: '1.350,00 TL' },
    { code: 'AYÖ', name: 'Özel Kesimli Tek Yön Varak Altın Yaldız', size: '5 x 8 cm', paper: 'Kuşe / 350 Gr.', lamination: 'Mat Selefon', sides: 'Çift Yön', qty: '1000', price: '1.100,00 TL' },
    { code: 'TFT', name: 'Tek Yön Kartvizit (Renkli) Fantazi tuale', size: '5.2 x 8.2 cm', paper: 'Fantazi Tual / 280 Gr.', lamination: 'Selefon Yok', sides: 'Tek Yön', qty: '1000', price: '600,00 TL' },
    { code: 'TFJ', name: 'Tek Yön Kartvizit (Renkli) Fantazi Japon Bristol', size: '5.2 x 8.2 cm', paper: 'Fantazi Japon / 300 Gr.', lamination: 'Selefon Yok', sides: 'Tek Yön', qty: '1000', price: '500,00 TL' },
    { code: 'TPK', name: 'Tek Yön Kartvizit (Renkli) Parlak Selefon', size: '5.2 x 8.2 cm', paper: 'A. Bristol / 270 Gr.', lamination: 'Parlak Selefon', sides: 'Tek Yön', qty: '1000', price: '195,00 TL' },
    { code: 'ABK', name: 'Tek Yön Kartvizit (Renkli) Arka Tek Renk Siyah Baskılı', size: '5.2 x 8.2 cm', paper: 'A. Bristol / 270 Gr.', lamination: 'Parlak Selefon', sides: 'Tek Yön', qty: '1000', price: '215,00 TL' },
    { code: 'TMK', name: 'Tek Yön Kartvizit (Renkli) Mat Selefon', size: '5.2 x 8.2 cm', paper: 'Kuşe / 350 Gr.', lamination: 'Mat Selefon', sides: 'Tek Yön', qty: '1000', price: '240,00 TL' },
    { code: 'ÇPK', name: 'Çift Yön Kartvizit (Renkli) Parlak Selefon', size: '5.2 x 8.2 cm', paper: 'Kuşe / 350 Gr.', lamination: 'Parlak Selefon', sides: 'Çift Yön', qty: '1000', price: '315,00 TL' },
    { code: 'ÇMK', name: 'Çift Yön Kartvizit (Renkli) Mat Selefon', size: '5.2 x 8.2 cm', paper: 'Kuşe / 350 Gr.', lamination: 'Mat Selefon', sides: 'Çift Yön', qty: '1000', price: '325,00 TL' },
    { code: 'ÇFT', name: 'Çift Yön Fantazi Tual', size: '5.2 x 8.2 cm', paper: 'Fantazi Tual / 280 Gr.', lamination: 'Selefon Yok', sides: 'Çift Yön', qty: '1000', price: '675,00 TL' },
    { code: 'ÇFJ', name: 'Çift Yön Fantazi Japon Bristol', size: '5.2 x 8.2 cm', paper: 'Fantazi Japon / 300 Gr.', lamination: 'Selefon Yok', sides: 'Çift Yön', qty: '1000', price: '575,00 TL' },
    { code: 'SVMO', name: 'Sıvama (Çift Taraf Kabartma Lak - Standart oval kesim)', size: '5 x 8 cm', paper: '300 Gr + 300 Gr / Amerikan Bristol', lamination: 'Mat Selefon', sides: 'Çift Yön', qty: '1000', price: '800,00 TL' },
    { code: 'ÇÖM', name: 'Kartvizit (Özel Kesimli - Bıçaklı)', size: '5 x 8 cm', paper: 'Kuşe / 350 Gr.', lamination: 'Mat Selefon', sides: 'Çift Yön', qty: '1000', price: '625,00 TL' },
    { code: 'ÖKL', name: 'Kartvizit (Çift Taraf Kabartma - Özel Kesimli)', size: '5 x 8 cm', paper: 'Kuşe / 350 Gr.', lamination: 'Mat Selefon', sides: 'Çift Yön', qty: '1000', price: '700,00 TL' },
    { code: 'SVMÖ', name: 'Sıvama (Çift Taraf Kabartma Lak - Özel Kesimli)', size: '5 x 8 cm', paper: '300 Gr + 300 Gr / Amerikan Bristol', lamination: 'Mat Selefon', sides: 'Çift Yön', qty: '1000', price: '900,00 TL' },
    ...
    { code: 'YAGK', name: 'Yağ Kartı (Arka Tekrenk Siyah Baskılı) 8 x 13.5', size: '8 x 13.5 cm', paper: 'A. Bristol / 270 Gr.', lamination: 'Tek Yön Parlak Selefon', sides: 'Çift Yön', qty: '1000', price: '1.650,00 TL' },
    { code: 'YAGKK', name: 'Yağ Kartı (Arka Tekrenk Siyah Baskılı) 6 x 10', size: '6 x 10 cm', paper: 'A. Bristol / 270 Gr.', lamination: 'Tek Yön Parlak Selefon', sides: 'Çift Yön', qty: '1000', price: '1.450,00 TL' },
    { code: 'KPASK1', name: 'Kapı Askılığı (10 x 23.5)', size: '10 x 23.5 cm', paper: 'Kuşe / 350 Gr.', lamination: 'İsteğe Bağlı', sides: 'Çift Yön', qty: '1000', price: '3.250,00 TL' },
    { code: 'KPASK2', name: 'Kapı Askılığı (10 x 32)', size: '10 x 32 cm', paper: 'Kuşe / 350 Gr.', lamination: 'İsteğe Bağlı', sides: 'Çift Yön', qty: '1000', price: '3.900,00 TL' }
  ],
  'el-ilani-brosur': [
    ...
    { code: 'BRŞ14', name: 'A4 Broşür (21 x 29.7)', size: '21 x 29.7 cm', paper: 'Kuşe / 170 Gr.', lamination: 'Mat Selefon', sides: 'Kırım Yok', qty: '1000', price: '3.250,00 TL' },
    { code: 'BRŞ10', name: 'A4 Broşür (21 x 29.7)', size: '21 x 29.7 cm', paper: 'Kuşe / 170 Gr.', lamination: 'Selefon Yok', sides: 'Kırım Yok', qty: '1000', price: '2.300,00 TL' },
    { code: 'BRŞ11', name: 'A4 Broşür (21 x 29.7 - Katlamalı)', size: '21 x 29.7 cm', paper: 'Kuşe / 170 Gr.', lamination: 'Selefon Yok', sides: 'Kırım Var', qty: '1000', price: '2.850,00 TL' },
    { code: 'BRŞ06', name: 'A4 Broşür (20 x 29.5)', size: '20 x 29.5 cm', paper: 'Kuşe / 150 Gr.', lamination: 'Selefon Yok', sides: 'Kırım Yok', qty: '1000', price: '1.800,00 TL' },
    { code: 'BRŞ07', name: 'A4 Broşür (20 x 29.5 - Katlamalı)', size: '20 x 29.5 cm', paper: 'Kuşe / 150 Gr.', lamination: 'Selefon Yok', sides: 'Kırım Var', qty: '1000', price: '2.350,00 TL' },
    { code: 'BRŞ21', name: 'A3 Broşür (29.7 x 42 - Kırımlı)', size: '29.7 x 42 cm', paper: 'Kuşe / 170 Gr.', lamination: 'Mat Selefon', sides: 'Kırım Var', qty: '1000', price: '6.500,00 TL' },
    { code: 'BRŞ20', name: 'A3 Broşür (29.7 x 42)', size: '29.7 x 42 cm', paper: 'Kuşe / 170 Gr.', lamination: 'Mat Selefon', sides: 'Kırım Yok', qty: '1000', price: '5.850,00 TL' },
    { code: 'BRŞ19', name: 'A3 Broşür (29.7 x 42 - Kırımlı)', size: '29.7 x 42 cm', paper: 'Kuşe / 170 Gr.', lamination: 'Parlak Selefon', sides: 'Kırım Var', qty: '1000', price: '6.350,00 TL' },
    ...
    { code: 'ELÇY02', name: 'Çift Yön (Renkli) El İlanı (13.5 x 19.5)', size: '13.5 x 19.5 cm', paper: 'Kuşe / 115 Gr.', lamination: 'Selefon Yok', sides: 'Kırım Yok', qty: '1000', price: '875,00 TL' },
    { code: 'ELÇY03', name: 'Çift Yön (Renkli) El İlanı (19.5 x 27)', size: '19.5 x 27 cm', paper: 'Kuşe / 115 Gr.', lamination: 'Selefon Yok', sides: 'Kırım Yok', qty: '1000', price: '1.750,00 TL' },
    { code: 'ELÇY04', name: 'Çift Yön (Renkli) El İlanı (27 x 39)', size: '27 x 39 cm', paper: 'Kuşe / 115 Gr.', lamination: 'Selefon Yok', sides: 'Kırım Yok', qty: '1000', price: '3.500,00 TL' },
